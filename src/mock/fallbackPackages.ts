...
export const getMockShipmentDetailsMap = (activeDefaultAddress?: UserAddress | null): Record<string, any> => {
  ...
  return {
    ...
    'mock-2': {
      ...
      events: [
        { id: 'e2-1', title: 'Transfer Aracında Yolda', description: 'Ankara Ana Merkezden İstanbul Dağıtım Merkezine sevk halinde.', location: 'Bolu Geçiş Noktası Transfer Hattı', event_time: '2026-08-17T23:10:00Z', status: 'transit' },
