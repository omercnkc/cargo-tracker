export const tr = {
  ...
  companyUnit: 'Firma',
  cargoUnit: 'kargo',
  noShipmentsYet: 'Henüz kayıtlı kargo bulunmuyor.',
  noShipmentsForMonth: 'için kargo kaydı yok.',
  total: 'Toplam',
  issues: 'Sorunlu',
  ...
  phoneInvalid: 'Geçerli bir telefon numarası giriniz (5XX...).',
  phoneLeadingZeroWarning: 'Numaranızı başında 0 olmadan giriniz (örn: 5XX XXX XX XX).',
  ...
  offlineBannerTitle: 'Çevrimdışı Moddasınız',
  offlineBannerDesc: 'İşlemleriniz kaydediliyor, internet geldiğinde eşitlenecek.',
  offlinePendingBadge: '{{count}} işlem kuyrukta',
  onlineBannerTitle: 'Yeniden Bağlandı 🟢',
  onlineBannerDesc: 'İnternet bağlantısı sağlandı, verileriniz senkronize edildi.',
